...
# Debug: Print available subjects
try:
    available_subjects = get_all_subjects()
    print(f"[DEBUG] Available subjects from database: {available_subjects}")
except Exception as e:
    print(f"[DEBUG] Error getting subjects: {e}")
    available_subjects = []
...
).format(", ".join(available_subjects) if available_subjects else "No subjects available")
